from utils_IXI import get_all_data_loaders, prepare_sub_folder, write_html, write_loss, get_config, write_2images, Timer, calculate_NMSE
import argparse
...
parser.add_argument('--config', type=str, default='configs/train_IXI.yaml', help='Path to the config file.')
...
while True:
    for it, (images_a, images_b) in enumerate(zip(train_loader_a, train_loader_b)):
        ...
        # print(images_a.size(), images_b.size())
        ...
        if (iterations + 1) % config['snapshot_save_iter'] == 0:
            ...
            # os.system('mkdir -p {}/iterations_{}'.format(checkpoint_directory, iterations))
            # os.system('cp -rfp ./*.py {}/iterations_{}'.format(checkpoint_directory, iterations))
